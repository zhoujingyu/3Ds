	    ...
	    _createClass(PictureWall, [{
	        ...
	        value: function getNextPage() {
	            ...
	            $.ajax({
	                ...
	                success: function success(data) {
	                    _this.loading = false;
	                    var tmp = '',
	                        len = data.length; //=buildList(data);
	                    for (var i = 0; i < len; i++) {
	                        tmp += _this.buildList(data[i]);
	                    }
	                    _this.$picBox.append(tmp);
	                    _this.currentPage++;
	                    _this.resize();
	        ...
	        value: function _scroll() {
	            ...
	            window.addEventListener('scroll', function () {
	                _this3.st = document.documentElement.scrollTop || document.body.scrollTop;
	                if (_this3.st + _this3.wh + 10 >= _this3.dh && !_this3.loading) {
	                    _this3.getNextPage();
	                }
	            });
	        }
